...
// use super::{
//     lifecycle::Lifecycle, ComponentStorage, ComponentType, EntityId, SparseSet, Tile, Value,
//     S32 as ComponentName,
// };

// pub struct MosaicEngine {
//     pub(crate) engine_state: Arc<ComponentStorage>,
...
//     fn register(&self, engine_state: Arc<ComponentStorage>);
// }

// impl Default for MosaicEngine {
//     fn default() -> Self {
//         let engine_state = ComponentStorage::new();
//         engine_state
